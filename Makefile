...
.PHONY: default prepare reset clean bin all run test help rerun recompile cleanrun allrun
...
run: all					## runs the project with default configs
	...
	./$(ASSIGNMENT) ./py_data_parser/parsed_data


rerun: $(ASSIGNMENT)		## recompiles if necessary and runs the project
	@printf "[\e[0;36mINFO\e[0m] Re-executing binary...\n"
	./$(ASSIGNMENT) ./py_data_parser/parsed_data
